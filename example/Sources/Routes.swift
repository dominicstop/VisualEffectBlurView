...
enum Route: String, CaseIterable {
  ...
  case visualEffectCustomFilterViewTest03;
  
  case visualEffectAnimatableCustomFilterViewTest01;
  ...
  var viewController: UIViewController {
    switch self {
      ...
      case .visualEffectCustomFilterViewTest03:
        return VisualEffectCustomFilterViewTest03Controller();
        
      case .visualEffectAnimatableCustomFilterViewTest01:
        return VisualEffectAnimatableCustomFilterViewTest01Controller();
  ...
  var subtitle: String {
    switch self {
      ...
      case .experiment01:
        return "Background + Foreground filter animation";
  ...
  var description: [AttributedStringConfig] {
    switch self {
      ...
      case .experiment01:
        return [
          .init(text: "Test for animating the background + foreground filters"),
          .newLines(2),
